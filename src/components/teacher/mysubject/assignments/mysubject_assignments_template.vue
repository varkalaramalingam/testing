<template>
    ...
    <div class="col-lg-12">
        ...
        <div class="col-lg-12 housestable reset-padding reset-margin">
            <div class="divTable">
        ...
        <router-view v-bind:mysubject="mysubject" v-bind:school="school" v-bind:userdetails="userdetails" v-bind:acdemicyearandboard="acdemicyearandboard" v-bind:assignments="assignments"></router-view>
    </div>
</template>
<script>
...
export default{
    ...
    created(){
        UserService.MySubjectAssignments(this.subject,this.id).then((response)=>{
    ...
    methods:{
        ...
        deleteassignment:function(assignment){
            ...
            UserService.DeleteMySubjectAssignment(assignmentid,this.id).then((response)=>{
                console.log(response);
        ...
        newassignment:function(){
            if(this.isValidAssignment()){
                ...
                console.log(assignment)
                UserService.AddMySubjectAssignment(assignment,this.id).then((response)=>{
                    if(response.status==200){
