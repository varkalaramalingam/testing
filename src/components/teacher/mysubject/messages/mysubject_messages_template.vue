                    ...
                    <div class="modal-body">
                        <form>
                            <div class="row">
                                ...
                                <div class="col-md-8 ">
                                    <!-- <multiselect v-model="newmessage.students" :options="options" :multiple="true" :value="options.id" :custom-label="customLabel">
                                    </multiselect> -->
                                     <multiselect v-model="newmessage.students"
                                        :options="options"
                                        :multiple="true"
                                    ></multiselect>
                                </div>
...
<script>
    ...
    export default{
        ...
        props:['mysubject','school','userdetails','acdemicyearandboard','academicsandboards'],
        data(){
            return{
                forreply:{
                    reply:false
        ...
        methods:{
            ...
            Newmessage:function(){
                ...
                for(let i=0;i<studentsIdsList.length;i++){
                    let studentid=studentsIdsList[i]
