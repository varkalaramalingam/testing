<template>
    <div>
        <div class="col-lg-12 text-left">
            <h3 class="student-head">New Worksheet</h3>
            <hr>
        </div>
                    ...
                    <div class="col-md-12">
                        <div class="leftside-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="worksheetname" placeholder="Name Of Worksheet*"   required>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-lg-offset-3 text-center">
                                    <router-link :to="{path:'/mysubjects/'+mysubject.gradenumber+mysubject.sectionname+'-'+mysubject.subjectname+'-'+mysubject.syllabustype+'/worksheets'}" tag="button" class="btn button">Cancel</router-link>
                                    <button id="btn-post" type="submit" name="submit"  class="btn button">Save</button>
                                </div>
                            </div>
                        </div>
                      </div>
