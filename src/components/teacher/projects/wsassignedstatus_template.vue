        ...
        <div class="divTable">
            <div class="divTableBody">
                <div class="divTableRow">
                    ...
                    <div class="divTableCell">Num of attempts</div>
                ...
                <div class="divTableRowdata">
                    <div class="divTableCelldata">1</div>
                    <div class="divTableCelldata">
                        Ravi  
                    </div>
                    <div class="divTableCelldata">24-05-2019</div>
                    <div class="divTableCelldata">24-05-2019</div>
                    <div class="divTableCelldata">24-05-2019</div>
                    <div class="divTableCelldata">2</div>
                    <div class="divTableCelldata">70</div>
                    <div class="divTableCelldata">Teja</div>
                    <div class="divTableCelldata">Not submitted</div>
                    <div class="divTableCelldata" v-if='userRole != "ADMIN"'> <button class='assign-button' 
                 v-on:click="popUp('libraryQuestionsPopUp',open);createWSAssignObj(workSheetIndex)">View</button></div>
        ...
        filterLibraryQuestions: function() {
            ...
            return this.libraryQuestions.filter(function(question) {
                ...
                if(!self.searchQuestionDesc){
                    ...
                    filterQuestionDesc = question.questionDescription.toLowerCase().indexOf(self.searchQuestionDesc.toLowerCase()) >= 0;
                }
                if(self.searchGradeId ==0){
                    filterGrade = true;
                }else{
                    filterGrade = question.gradeid.toString().indexOf(self.searchGradeId.toString()) >= 0;
                }
                if(self.searchSubjectId == 0){
                    filterSubject = true;
                }else{
                    filterSubject = question.subjectid.toString().indexOf(self.searchSubjectId.toString()) >= 0;
                }
                if(self.searchDifficultyId == 0){
                    filterDifficulty = true;
                }else{
                    filterDifficulty = question.degreeofdifficultyid.toString().indexOf(self.searchDifficultyId.toString()) >= 0;
                }
                ...
                return filterQuestionDesc && filterGrade && filterSubject && filterDifficulty && filterExistingQuestion;
            });
        },
        paginatedDataQues() {
