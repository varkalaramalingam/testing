                ...
                <ul class="nav navbar-nav ">
                  ...
                  <li>
                    <router-link to="#" active-class="active"
                      ><span v-html="$t('notifications_cap')"
                    /></router-link>
                  </li>
                  <li>
                    <router-link to="/my-children/tests" active-class="active"
                      ><span v-html="$t('ward_cap')"
                    /></router-link>
                  </li>
                </ul>
              </div>
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body" style="height: 162px;">
            <br />
            <!-- v-on:change="changingacademicyear()" -->
            <select
            ...
            >
              ...
              <option
                ...
                :key="academic.id"
                >{{ academic.passingyear }}</option
              >
            </select>
            <br /><!-- v-on:change="changingboard" -->
            <select
              class="form-control popUpEle"
